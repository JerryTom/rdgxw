<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editPwd.aspx.cs" Inherits="Admin_User_editPwd" %>
            ...
            <div id="forinput">
                ...
                <dl>
                    ...
                    <dd class="content_menu">
                        <input id="UserName" name="UserName" class="input_style" type="text" placeholder="只能输入'A-Z','a-z','0-9','_'" tabindex="1" maxlength="12" runat="server" onblur="validate(this.id)" />
                    </dd>
                    <dd class="title_menu">
                        用户类型：
                    </dd>
                    ...
                    <dd class="title_menu">
                        原密码：<asp:Label ID="_oldPwd" runat="server" Text="原密码不正确" ForeColor="Red" Visible="False"></asp:Label>
                    </dd>
                    <dd class="content_menu">
                       <input id="PassWord" name="PassWord" type="password" class="input_style"  placeholder="输入您的原密码" tabindex="2" maxlength="18" runat="server" />
                    </dd>
                    <dd class="title_menu">
                        新密码：<asp:Label ID="_PassWord" runat="server" Text="两次输入密码不一致" ForeColor="Red" Visible="False"></asp:Label>
                    </dd>
                    <dd class="content_menu">
                    ...
                    <dd class="title_menu">
                        <asp:Button ID="but_user" CssClass="but_style" runat="server" Text="修  改" OnClick="but_user_Click" />
