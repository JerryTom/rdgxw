...
public partial class web_AgricultTech : System.Web.UI.Page
{
    ...
    {
        B_InforData bf = new B_InforData();
        dgPager.RecordCount = bf.getAgricultTechCount();
        dgPager.PageSize = 15;
        dataTable.InnerHtml = bf.getAgricultTech(dgPager.StartRecordIndex, dgPager.EndRecordIndex);
    }
