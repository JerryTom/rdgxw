...
public partial class web_Economicnews : System.Web.UI.Page
{
    ...
    {
        B_InforData bf = new B_InforData();
        dgPager.RecordCount = bf.getEconomicnewsCount();
        dgPager.PageSize = 15;
        dataTable.InnerHtml = bf.getEconomicnews(dgPager.StartRecordIndex, dgPager.EndRecordIndex);
    }
