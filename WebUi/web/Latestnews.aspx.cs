...
public partial class web_Latestnews : System.Web.UI.Page
{
    ...
    {
        B_InforData bf = new B_InforData();
        dgPager.RecordCount = bf.getLatestnewsCount();
        dgPager.PageSize = 15;
        dataTable.InnerHtml = bf.getLatestnews(dgPager.StartRecordIndex, dgPager.EndRecordIndex);
    }
