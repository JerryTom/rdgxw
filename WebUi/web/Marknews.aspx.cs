...
public partial class web_Marknews : System.Web.UI.Page
{
    ...
    {
        B_InforData bf = new B_InforData();
        dgPager.RecordCount = bf.getMarknewsCount();
        dgPager.PageSize = 15;
        dataTable.InnerHtml = bf.getMarknews(dgPager.StartRecordIndex, dgPager.EndRecordIndex);
    }
