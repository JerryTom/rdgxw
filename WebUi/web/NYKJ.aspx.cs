...
public partial class web_NYKJ : System.Web.UI.Page
{
    ...
    {
        B_InforData bf = new B_InforData();
        dgPager.RecordCount = bf.getNYKJCount();
        dgPager.PageSize = 15;
        dataTable.InnerHtml = bf.getNYKJ(dgPager.StartRecordIndex, dgPager.EndRecordIndex);
    }
