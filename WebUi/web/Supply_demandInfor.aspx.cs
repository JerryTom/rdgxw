...
public partial class web_Supply_demandInfor : System.Web.UI.Page
{
    ...
    {
        B_InforData bf = new B_InforData();
        dgPager.RecordCount = bf.getSupply_demandInforCount();
        dgPager.PageSize = 15;
        dataTable.InnerHtml = bf.getSupply_demandInfor(dgPager.StartRecordIndex, dgPager.EndRecordIndex);
    }
